...
urlpatterns = [
    ...
    path('cart/', include(('burger.cart.urls', 'cart'), namespace='cart')),
    path('login/', index_view.login,name='login'),
    path('about/', index_view.about,name='about'),
    path('privacy_policy/', index_view.privacy_policy,name='privacy_policy'),
    path('contact', index_view.save_contact, name="save_contact"),
    path('reset/', index_view.reset_password,name='reset'),
    path('register/', index_view.register,name='register'),
    path('profile/', include('burger.people.urls')),
    path('burger/', include('burger.burguer.urls')),
    path('dashboard/', include('burger.dashboard.urls')),
    path('raffle/', include('burger.offer.urls')),
    path('menu/', index_view.load_menu, name="menu"),
    path(
    r'^reset-password/',
